...
from trainsformers import WarmupLinearSchedule
...
def train_ner_model(
	...
	logger_file_path=None, labels_file=None
):
	...
	scheduler = WarmupLinearSchedule(
		optimizer, warmup_steps=model_config_dict["warmup_steps"],
		t_total=t_total
	)
	...
	for epoch in range(model_config_dict["num_epochs"]):
		...
		if best_eval_f1 < eval_result["f1"]:
			...
			model_to_save.config.to_json(output_config_file)
